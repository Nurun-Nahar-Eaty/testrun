...
<body>
    ...
    <nav class="navbar navbar" style="background-color: #B8E2FA;">
        <div class="container-fluid">
            <div class="navbar-header">
                <img src="/Arpa/imagess/bup.png" id="Buplogo">
            </div>
            <div class="navbar-header">
    ...
    <div class="library_logo">
        <img src="/Arpa/images/bup_library_logo.png" alt="">
    </div>
    <div6 class="sear">
    ...
    <div>
        ...
        <div class="tab">
            <table class="GeneratedTable">
                <thead>
                    <tr>
                        <th style="font-weight: bolder;  color:#044F2B  ;">Books</th>
                        <th style="font-weight: bolder;  color:#044F2B  ;">Holdings</th>
                        <th style="font-weight: bolder;  color:#044F2B  ;">Renew</th>
                        <th style="font-weight: bolder;  color:#044F2B  ;">Checkout Date</th>
                        <th style="font-weight: bolder;  color:#044F2B  ;">Returned Date</th>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="font-weight:bolder; color:#044F2B;">Book
                    History</li>
            </ol>
        </nav>
    </div>
