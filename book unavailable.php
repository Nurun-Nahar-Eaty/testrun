...
<head>
    ...
    <link rel="stylesheet" href="book unavailable.css">
...
<body>
    ...
    <div class="book"><img src="/Arpa/images/book6.jpg" alt="" height="160px" width="120px"></div>
    <div4 class="library_logo_name">
        <img src="bup_library_logo.png" alt="">
    </div4>
    <div class="button1"><a class="btn btn-default" href="#" role="button">
            <div class="bcolor">Unavailable</div>
        </a>
    </div>
    <div class="book_detail1"><br>Artificial Intelligence/ Douglas A. Lind, William G. Marchal, Samuel A. Wathen.</br>
    ...
    <!-- <div> 
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="userhome1.php">Home</a></li>
