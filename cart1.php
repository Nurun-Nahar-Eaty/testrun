...
<body>
    ...
    <div>
        ...
        <div class="button33" id="button333"><a class="btn btn-primary" href="cart2.php" role="button">
        ...
        <div class="tab">
            ...
            <td></td>
                    ...
                    <tr>
                        ...
                        <td class="th1"><button type="button" class="btn btn-danger" onClick="hideTr()">Cancel</button>
                        </td>
                    </tr>
                    <tr>
